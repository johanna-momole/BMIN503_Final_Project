...
-   **Poverty**: The second most influential feature in the XGBoost model, with an importance score of approximately 0.3. Economic barriers significantly impact vaccination coverage, as families in porverty often face challenges like cost, accessibility, and healthcare literacy.

-   **Insurance**: Although ranked third, health insurance coverage still contributes notably to the model with a relative importance score of around 0.2. Insurance often determines access to preventive care, such as HPV vaccines, and uninsured populations are less likely tom complete vaccination regimens due to financial constraints.

...
-   **ROSE**: Balancing imbalanced datasets using oversampling techniques.
-   **pROC**: Generating ROC curves for model evaluation.
...
install.packages(c("tidyverse", "nhanesA", "caret", "xgboost", "ROSE", "pROC", "MLmetrics"))
```
...
barplot(
  ...
  xlab = "HPV Vaccination (1: Yes, 2: No)",
  ylab = "Frequency",
...
barplot(
  ...
  xlab = "Insurance (1: Covered, 2: Not Covered)",
  ylab = "Frequency",
...
Two models, **logistic regression** and **XGBoost**, were implemented to predict HPV vaccination outcomes. The SMOTE technique was applied to balance class distributions.
